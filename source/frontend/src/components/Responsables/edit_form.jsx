...
const EditForm = ({ trigger, setTrigger, setRefresh, id, nombre }) => {
    /* Manages popup */
    const [formStatus, setFormStatus] = useState(false);
    const [IDResponsable] = React.useState(id);
    ...
    function handleForm(event) {
        ...
        fetch('/backend/responsables/edit/guardar', {
            method: 'POST',
        ...
        .then(function (body) {
            console.log(body);
            setFormStatus({ success: true, message: 'El responsable ha sido editado de forma exitosa.' });
        })
        .catch(function (error) {
            console.error('There has been a problem with your fetch operation:', error);
            setFormStatus({ success: false, message: 'Se produjo un error y no se pudo editar el responsable.' });
        });
    }
                ...
                <form method="POST" onSubmit={handleForm}
                    ...
                    <div class="">
                        <div class="pt-5 w-full md:w-6/12">
                            ...
                            id="Nombre" type="text" placeholder={Nombre} value={Nombre}/>
                        </div>
